...
*/CREATE TABLE Jobs (ID INT NOT NULL, PCN INT NOT NULL, VMID INT NOT NULL, JOBENABLE INT NOT NULL, JOBNUMBER NVARCHAR(32) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL, DESCR NVARCHAR(50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL);
