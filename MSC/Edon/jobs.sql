...
on j.JOBNUMBER = a.JOBNUMBER 
where a.VMID = 5
select * from NewSetupData nsd where ParamValueDefault like '%job%' or PARAM like '%job%'
select * from SetupData sd where ParamValueDefault like '%job%' or DESCR like '%job%' or PARAM like '%job%'
