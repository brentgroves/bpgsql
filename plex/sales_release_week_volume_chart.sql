...
create table #sales_release_weekly_volume_pivot 
(
  year_week_fmt varchar(10),
...
insert into #sales_release_weekly_volume_pivot  (year_week_fmt,[H2GC 5K652 AB],p.[H2GC 5K651 AB],p.[10103355_Rev_A],[10103353_Rev_A],[AA96128_Rev_B],[Other])
...
PIVOT
(
  SUM(volume) FOR part_no IN ([H2GC 5K652 AB],[H2GC 5K651 AB],[10103355_Rev_A],[10103353_Rev_A],[AA96128_Rev_B],[Other])
) AS p;

--select * from #sales_release_weekly_volume_revenue_pivot 

create table #sales_release_week_volume_chart
(
  year_week_fmt varchar(10),
  [H2GC 5K652 AB] decimal,
  [H2GC 5K651 AB] decimal,
  [10103355_Rev_A] decimal,
  [10103353_Rev_A] decimal,
  [AA96128_Rev_B] decimal,
  [Other] decimal
)

insert into #sales_release_week_volume_chart (year_week_fmt,[H2GC 5K652 AB],[H2GC 5K651 AB],[10103355_Rev_A],[10103353_Rev_A],[AA96128_Rev_B],[Other])
select pk.year_week_fmt,
(
select [H2GC 5K652 AB] 
from #sales_release_weekly_volume_pivot vr
...
select * from  #sales_release_week_volume_chart
