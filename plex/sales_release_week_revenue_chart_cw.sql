...
set @start_week = DATEPART(WEEK,GETDATE())
set @end_year = DATEPART(YEAR,GETDATE())
set @end_week = DATEPART(WEEK,GETDATE())
...
--CONVERT HARD CODED INFO TO USE DATA FROM #volume_revenue_info
--update #volume_revenue_info to take work week param OR hard code it to a specific date range
