...
exec sproc300758_11728751_1823661 @End_Ship_Date, @Building_Key
--select distinct release_status from sales_v_release_status
-- 	release_status
--1	Canceled
--2	Closed
...
-- select count(*) #sales_release from #sales_release  --66 01/12/2021 
...
insert into #sales_release_row_number (row_number,release_key,part_key,customer,po,release,ship_to,part_no,cust_part,part_name,ship_date,
...
-- select count(*) #sales_release_row_number from #sales_release_row_number --66
--where release = ''  --53
...
insert into #sales_release_rel_due (row_number,release_key,part_key,customer,po,release,ship_to,part_no,cust_part,part_name,ship_date,
last_shipped_shipper,last_active_shipper,due_date,rel_qty,qty_loaded, shipped,rel_bal,rel_due,total_rel_due,release_status,release_type)
(
select
row_number,
release_key,
...
-- select count(*) #sales_release_rel_due from #sales_release_rel_due  --66
...
insert into #sales_release_qty_ready_avail (row_number,release_key,part_key,customer,po,release,ship_to,part_no,cust_part,part_name,ship_date,
last_shipped_shipper,last_active_shipper,due_date,rel_qty,qty_loaded, shipped,rel_bal,rel_due,total_rel_due,release_status,release_type,tot_qty_ready,tot_qty_wip,qty_ready_avail)
(
...
insert into #sales_release_qty_ready (row_number,release_key,part_key,customer,po,release,ship_to,part_no,cust_part,part_name,ship_date,
last_shipped_shipper,last_active_shipper,due_date,rel_qty,qty_loaded, shipped,rel_bal,rel_due,total_rel_due,release_status,release_type,tot_qty_ready,tot_qty_wip,qty_ready_avail,qty_ready,rel_bal2)
(
...
-- select count(*)  #sales_release_qty_ready from  #sales_release_qty_ready  --66
...
insert into #sales_release_rel_due2 (row_number,release_key,part_key,customer,po,release,ship_to,part_no,cust_part,part_name,ship_date,
last_shipped_shipper,last_active_shipper,due_date,rel_qty,qty_loaded, shipped,rel_bal,rel_due,total_rel_due,release_status,release_type,tot_qty_ready,tot_qty_wip,qty_ready_avail,qty_ready,rel_bal2,rel_due2)
(
...
-- select count(*)  #sales_release_rel_due2 from  #sales_release_rel_due2  --66
...
insert into #sales_release_wip_avail (row_number,release_key,part_key,customer,po,release,ship_to,part_no,cust_part,part_name,ship_date,
last_shipped_shipper,last_active_shipper,due_date,rel_qty,qty_loaded, shipped,rel_bal,rel_due,total_rel_due,release_status,release_type,tot_qty_ready,tot_qty_wip,qty_ready_avail,qty_ready,rel_bal2,rel_due2,qty_wip_avail)
(
...
insert into #sales_release_wip (row_number,release_key,part_key,customer,po,release,ship_to,part_no,cust_part,part_name,ship_date,
last_shipped_shipper,last_active_shipper,due_date,rel_qty,qty_loaded, shipped,rel_bal,rel_due,total_rel_due,release_status,release_type,tot_qty_ready,
...
-- select count(*)  #sales_release_wip from  #sales_release_wip  --66
...
insert into #customer_releases (release_key, part_key,customer,po,release,ship_to,part_no,cust_part,part_name,qty_ready,qty_loaded,qty_wip,ship_date,
last_shipped_shipper,last_active_shipper,due_date,rel_qty,shipped,rel_bal,total_rel_due,release_status,release_type)
(
  select
...
-- select count(*) #customer_releases from #customer_releases  --66
select 
  --release_key,
  --part_key,
  customer,
