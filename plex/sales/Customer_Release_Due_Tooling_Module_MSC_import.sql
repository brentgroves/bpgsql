...
insert into #sales_release_part (pcn,release_key,po_line_key,release_status_key,release_type_key,po_status_key,part_key,release_no,ship_to,ship_date, due_date,quantity,quantity_shipped,past_due)
select 
--top 10
sr.pcn,
sr.release_key,
...
where part_no like  '%001-0408-04D%'
order by si.qty_due desc