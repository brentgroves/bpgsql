...
where part_no = 'H2GC 5K652 AB'  --1
and year_week_fmt = pk.year_week_fmt
) [H2GC_5K652_AB],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = 'H2GC 5K651 AB'  --2
and year_week_fmt = pk.year_week_fmt
) [H2GC_5K651_AB],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = '10103353_Rev_A'  --3
and year_week_fmt = pk.year_week_fmt
) [10103353_Rev_A],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = '10103355_Rev_A'  --4
and year_week_fmt = pk.year_week_fmt
) [10103355_Rev_A],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = 'AA96128_Rev_B'  --5
and year_week_fmt = pk.year_week_fmt
) [AA96128_Rev_B],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = '727110F'  --6
and year_week_fmt = pk.year_week_fmt
) [727110F],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = '10103357_Rev_A'  --7
and year_week_fmt = pk.year_week_fmt
) [10103357_Rev_A],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = '10103358_Rev_A'  --8
and year_week_fmt = pk.year_week_fmt
) [10103358_Rev_A],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = 'A52092_Rev_T'  --9
and year_week_fmt = pk.year_week_fmt
) [A52092_Rev_T],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = '10103353CX_Rev_A'  --10
and year_week_fmt = pk.year_week_fmt
) [10103353CX_Rev_A],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = '68400221AA_Rev_08'  --11
and year_week_fmt = pk.year_week_fmt
) [68400221AA_Rev_08],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = '18190-RNO-A012-S10_Rev_02'  --12
and year_week_fmt = pk.year_week_fmt
) [18190-RNO-A012-S10_Rev_02],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = '10103355CX_Rev_A'  --13
and year_week_fmt = pk.year_week_fmt
) [10103355CX_Rev_A],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = 'R558149_Rev_E'  --14
and year_week_fmt = pk.year_week_fmt
) [R558149_Rev_E],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = 'A92817_Rev_B'  --15
and year_week_fmt = pk.year_week_fmt
) [A92817_Rev_B],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = 'R559324RX1_Rev_A'  --16
and year_week_fmt = pk.year_week_fmt
) [R559324RX1_Rev_A],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = '10046553_Rev_N'  --17
and year_week_fmt = pk.year_week_fmt
) [10046553_Rev_N],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = '26088054_Rev_07B'  --18
and year_week_fmt = pk.year_week_fmt
) [26088054_Rev_07B],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = '2017707_Rev_J'  --19
and year_week_fmt = pk.year_week_fmt
) [2017707_Rev_J],(
select revenue  
from #sales_release_week_volume_revenue vr
where part_no = '2017710_Rev_J'  --20
and year_week_fmt = pk.year_week_fmt
) [2017710_Rev_J],(
select revenue  
from #sales_release_week_volume_revenue vr
