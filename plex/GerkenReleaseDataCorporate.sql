...
insert into #set2groupA(release_key,release_no,part_key,quantity)
(
  select 
  sr.release_key,
  sr.release_no,
...
insert into #result (primary_key,part_key,part_no,name,unit_price,total_quantity,total_price)
(
  select 
  pk.primary_key,
  pk.part_key,
