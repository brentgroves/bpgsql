...
--set @end_of_week_for_end_date = DATEADD(second,-1,@end_of_week_for_end_date);    
    ...
    and pl.part_key not in (2684943,2684942,2794731,2794706,2793953)
  )s1 
...
(
  ...
  (
    ...
    and ss.shipper_status='Shipped' and pl.part_key not in (2684943,2684942,2794731,2794706,2793953)
  )sl
