...
--select count(*) #volume_revenue from #volume_revenue  --9
...
create table #sales_release_week_low_volume_revenue_releases
(
  primary_key int,
  part_key int,
...
insert into #sales_release_week_low_volume_revenue_releases (primary_key,part_key,year_week,year_week_fmt,start_week,end_week,part_no,volume,revenue)
(
  select
  primary_key,
  part_key,
...
*
--distinct part_key
from #sales_release_week_low_volume_revenue_releases
