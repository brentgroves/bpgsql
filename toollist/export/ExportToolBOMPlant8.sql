...
-- truncate table PlexToolBOMPlant8
-- drop table PlexToolBOMPlant8
create table PlexToolBOMPlant8
(
...
-- where a.Operation <> 'Machine Complete'
	 ...
	 */
	select count(*) cnt from PlexToolBOMPlant8 -- 51
	select * from PlexToolBOMPlant8 
	select * from PlexToolBOMPlant8 
...
--	select * from dbo.bvToolListItemsMiscOnlyLv1 btlimol where processid = 54071  48625  54522 50868 54351 54339 63710 63747 62372 63810 --63810
...
--	select * from dbo.bvToolListItemsFixtureOnlyLv1 btlimol where processid = 54071 48625 54522 50868 54351 54339 63710 63747 62372 63811 63810 --61622 --14218 --63810
-- select count(*) from btDistinctToolLists tb  -- 521
-- select * from btDistinctToolLists tb  -- 521  
-- where processid = 63810
--	select * from dbo.PlexToolBOMPlant8 
