...
CREATE TABLE [Busche ToolList].dbo.TL_Plex_PN_Op_Map_Albion (
...
select 
-- tl.processid,tl.customer,tl.partfamily,tl.OperationDescription,
tl.ProcessID,
tl.partNumber TL_Part_No,
'10103355' Plex_Part_No,
'A' Revision,
'Machine A - WIP' Operation_Code
into TL_Plex_PN_Op_Map_Albion
from dbo.bvToolListsInPlants tl 
where plant = '6' and tl.processid  = 61748
order by tl.partNumber
