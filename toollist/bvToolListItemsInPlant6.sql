...
(
	...
	from 
	(
		select distinct iip.itemNumber from bvToolListItemsInPlants iip where iip.plant = 6
	)iip
)rs 
where Row# between 0 and 400
where Row# between 401 and 800 -- 721
/*
...
(
	...
	(
		...
		-- select * FROM [TOOLLIST tool] as tt where tt.UDFGLOBALTOOL = 1
