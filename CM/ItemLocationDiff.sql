...
into station111620
from STATION
select count(*) cnt from station111620
11 12679 11/16
-- 12679 11/03
-- 12679 10/26
-- 12679 10/19
...
select top 100 * from station111620
-- Upload the item_location table into PlxSupplyItemLocation table.
CREATE TABLE Cribmaster.dbo.PlxSupplyItemLocation111620 (
	item_no varchar(50),
	location varchar(50),
	quantity integer
)
...
Bulk insert PlxSupplyItemLocation111620
from 'c:\il1116GT12500.csv'
with
(
	fieldterminator = ',',
	rowterminator = '\n'
...
count(*)
-- top 1000 * 
from PlxSupplyItemLocation111620 
-- Check for duplicates
select count(*)
from 
(
select distinct item_no,location from PlxSupplyItemLocation111620
)s1
-- 14649 11/16
-- 14,613 11/03
-- 14,605 10/26
...
--il.item_no,il.location,il.quantity
 into nic111620 --Plex supply items with the default location and a quantity = 0
--  count(*) 
 -- 3821 11/16
 -- 3788 11/03
 -- 3783 10/26
...
--0729=183
-- DROP OLD TABLES
--drop table PlxSupplyItemLocation110320
--drop table station110320
--drop table nic110320
