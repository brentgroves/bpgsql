...
into station112020
from STATION
select count(*) cnt from station112020
-- 12679 11/20
-- 12679 11/16
-- 12679 11/03
-- 12679 10/26
...
select top 100 * from station112020
-- Upload the item_location table into PlxSupplyItemLocation table.
CREATE TABLE Cribmaster.dbo.PlxSupplyItemLocation112020 (
	item_no varchar(50),
	location varchar(50),
	quantity integer
)
...
Bulk insert PlxSupplyItemLocation112020
from 'c:\il1120GT12500.csv'
with
(
	fieldterminator = ',',
	rowterminator = '\n'
...
count(*)
-- top 1000 * 
from PlxSupplyItemLocation112020 
-- Check for duplicates
select count(*)
from 
(
select distinct item_no,location from PlxSupplyItemLocation112020
)s1
-- 14652 11/20
-- 14649 11/16
-- 14,613 11/03
...
--il.item_no,il.location,il.quantity
 into nic112020 --Plex supply items with the default location and a quantity = 0
--  count(*) 
  -- 3814 11/20
 -- 3821 11/16
 -- 3788 11/03
...
--0729=183
-- DROP OLD TABLES
--drop table PlxSupplyItemLocation111620
--drop table station111620
--drop table nic111620
