...
CREATE TABLE Kep13319 (
	...
	PCN varchar(50) DEFAULT NULL,
  	...
  	Cycle_Counter_Shift_SL int(11) DEFAULT NULL,
...
call InsKep13319('test', 123,'Avilla',123, 'CNC103', '103', 5, @transDate); 
...
(
	...
	IN pcn varchar(50),
  	...
  	IN cnc varchar(6),
  	IN cycle_Counter_Shift_SL int(11),
  	IN transDate datetime
)
BEGIN
   
INSERT INTO Kep13319 
(NodeId,Plexus_Customer_No,PCN, Workcenter_Key,Workcenter_Code,CNC,Cycle_Counter_Shift_SL,TransDate)
VALUES(nodeId,plexus_Customer_No,pcn, workcenter_Key,workcenter_Code,cnc,cycle_Counter_Shift_SL,transDate);
